...
# 加载底层接口
from negociant.trader.gateway import (ctpGateway, ibGateway)

if system == 'Linux':
    from negociant.trader.gateway import xtpGateway
elif system == 'Windows':
    from negociant.trader.gateway import (femasGateway, xspeedGateway,
                                     secGateway)

# 加载上层应用
from negociant.trader.app import (riskManager, ctaStrategy, 
