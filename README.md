...
The Negociant project was originally forked off from an open source project named "vnpy" in 2017, further develped, enhanced, customized, thoroughly tested and launched for automated trading of the Chinese futures markets by the CTP protocals.
...
2. Event engine and RPC framework are as with the vnpy project.
...
### No waranty and no guarantee of porfits

While the system has been thoroughly tested and extensively used in live trading for years, the author here offers no waranty and absolutely no guarantee for your profits.
