...
from negociant.trader.uiQt import QtWidgets
from negociant.trader.app.algoTrading.algoTemplate import AlgoTemplate
from negociant.trader.app.algoTrading.uiAlgoWidget import AlgoWidget, QtWidgets
...
class DmaWidget(AlgoWidget):
    ...
    def initAlgoLayout(self):
        ...
        grid.addWidget(Label('类型'), 4, 0)
        grid.addWidget(self.comboPriceType, 4, 1)
        grid.addWidget(Label('开平'), 5, 0)
