...
from negociant.rpc import RpcClient, RpcServer, RemoteException
...
class BacktestingEngine(object):
    ...
    def newBar(self, bar):
        ...
        self.strategy.onBacktestBar(bar)    # 推送K线到策略中
    ...
    def crossStopOrder(self):
        ...
        for stopOrderID, so in list(self.workingStopOrderDict.items()):
            ...
            if buyCross or sellCross:
                ...
                self.tradeDict[tradeID] = trade
                # print(trade.dt, trade.volume, trade.direction, trade.offset, trade.price)
