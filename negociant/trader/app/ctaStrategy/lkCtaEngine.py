...
from negociant.trader.vtObject import VtTickData, VtBarData
from negociant.trader.vtGateway import VtSubscribeReq, VtOrderReq, VtCancelOrderReq, VtLogData
...
from negociant.trader.app import AppEngine
...
class CtaEngine(AppEngine):
    ...
    def __init__(self, mainEngine, eventEngine):
        ...
        print("lkCtaEngine init MarketsHours")
    ...
    def processTickEvent(self, event):
        ...
        if self.marketHours.isMarketOpen(tick.vtSymbol, tick.exchange, tick.time) :
