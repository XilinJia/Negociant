...
from negociant.trader.app.ctaStrategy.ctaTemplate import CtaTemplate
...
class MultiTimeframeStrategy(CtaTemplate):
    ...
    def __init__(self, ctaEngine, setting):
        ...
        # 创建K线合成器对象
        self.bg5 = BarGenerator()     # 创建K线合成器对象
        self.bg5.requireXMinBar(5, self.on5MinBar)
        self.am5 = ArrayManager()
        
        self.bg15 = BarGenerator()     # 创建K线合成器对象
        self.bg15.requireXMinBar(15, self.on15MinBar)
    ...
    def onBar(self, bar):
        """收到Bar推送（必须由用户继承实现）"""
        # 基于15分钟判断趋势过滤，因此先更新
        self.bg15.updateWithMinuteBar(bar)
        
        # 基于5分钟判断
        self.bg5.updateWithMinuteBar(bar)
