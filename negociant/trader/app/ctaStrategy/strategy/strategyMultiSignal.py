...
from negociant.trader.app.ctaStrategy.ctaTemplate import TargetPosTemplate, CtaTemplate, CtaSignal
...
class MaSignal(CtaSignal):
    ...
    def __init__(self):
        ...
        self.bg = BarGenerator()     # 创建K线合成器对象
        self.bg.requireXMinBar(5, self.onFiveBar)
        self.am = ArrayManager()        
    ...
    def onBar(self, bar):
        """K线更新"""
        self.bg.updateWithMinuteBar(bar)
