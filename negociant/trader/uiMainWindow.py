...
from negociant.trader.vtFunction import loadIconPath
from negociant.trader.vtGlobal import globalSetting
from negociant.trader.uiBasicWidget import *
...
class AboutWidget(QtWidgets.QDialog):
    ...
    def initUi(self):
        ...
        text = """
            ...
            Website：www.negociant.org

            Github：www.github.com/negociant/negociant
